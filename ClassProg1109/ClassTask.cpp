...
/*
    ...
    std::cout << "number = " << mass[number] << std::endl;
*/
    ...
    std::cout << "Ваша песня сегодня:" << music[arr[0]%14] << '\n';
    std::cout << "Ваш фильм сегодня:" << movies[arr[1]%14]<< '\n';
    std::cout << "Ваш актер сегодня:" << actors[arr[2]%14] << '\n';
    std::cout << "Ваша актрисса сегодня:" << actriss[arr[3]%14] << '\n';
    std::cout << "Ваша целеба сегодня:" << celeb[arr[4]%14] << '\n';
