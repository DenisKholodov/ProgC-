...
int main()
{
    ...
    std::string tom1 = "C:\\Prod\\ProgC-\\17-map\\tolstoj_lew_nikolaewich-text_0040.txt";
    std::string tom2 = "C:\\Prod\\ProgC-\\17-map\\tolstoj_lew_nikolaewich-text_0050.txt";
    std::string tom3 = "C:\\Prod\\ProgC-\\17-map\\tolstoj_lew_nikolaewich-text_0060.txt";
    std::string tom4 = "C:\\Prod\\ProgC-\\17-map\\tolstoj_lew_nikolaewich-text_0070.txt";

    std::string alphabet = "¸éöóêåíãøùçõúôûâàïðîëäæýÿ÷ñìèòüáþ";
